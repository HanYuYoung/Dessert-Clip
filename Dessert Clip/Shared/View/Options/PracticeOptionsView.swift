...
struct PracticeOptionsView_Previews: PreviewProvider {
    static var previews: some View {
        PracticeOptionsView(selection: .constant(0), options: drinksData[4].menus[0].practice)
    }
}
